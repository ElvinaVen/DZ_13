...
print("\n---Задание 3*---")
new_product_object2 = Product.create_new_product_object(product_name='Киви', product_description="Кислый", product_price=90.0, product_quantity=9)
src_file = Category.add_product_in_category(name1, new_product_object, src_file)

a = Category.get_products(name1, src_file)
Product.verification(a, new_product_object2)
